...
import { MapPin, Phone, Mail, Clock, User, MessageSquare, Calendar, Users, Send, CheckCircle, AlertCircle, Briefcase } from "lucide-react";
...
const ContactSection = () => {
  ...
  const [resForm, setResForm] = useState<ReservationData>({
    name: "", email: "", date: "", time: "", guests: "", occasion: "", message: "",
  });
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-4">
              {[
                { icon: MapPin, label: "Address", text: "Aviation Plaza, opposite parking yard, Juba International Airport, South Sudan" },
                { icon: MapPin, label: "Access", text: "Enter from inside airport or outside gate next to B One Supermarket" },
